    ...
    if(funcionario.id < atual->funcionario.id){
        if((res = insere_arvAVL(&(atual->esq), funcionario)) == 1){
            if(fatorBalanceamento_NO(atual) >= 2){
                if(funcionario.id < (*raiz)->esq->funcionario.id){
                    rotacaoLL(raiz);
                }else{
                    rotacaoLR(raiz);
                }
        ...
        if(funcionario.id > atual->funcionario.id){
            if((res = insere_arvAVL(&(atual->dir), funcionario)) == 1){
                if(fatorBalanceamento_NO(atual) >= 2){
                    if((*raiz)->dir->funcionario.id < funcionario.id){
                        rotacaoRR(raiz);
                    }else{
                        rotacaoRL(raiz);
                    }
...
int remove_arvAVL(arvAVL *raiz, FuncionarioAVL funcionario){
    ...
    int res;
    if(funcionario.id < (*raiz)->funcionario.id){
    ...
    if((*raiz)->funcionario.id < funcionario.id){
    ...
    if((*raiz)->funcionario.id == funcionario.id){
        if(((*raiz)->esq == NULL) || (*raiz)->dir == NULL){
            ...
            (*raiz)->funcionario.id = temp->funcionario.id;
